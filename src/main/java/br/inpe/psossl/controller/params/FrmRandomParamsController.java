 ...
 */
public class FrmRandomParamsController extends FrmParamsController {
	...
	protected void okEdiParams(ActionEvent event) throws IOException {
		...
		RandomAlgorithm.MAX = txtMAX.getNumber().intValue();
	...
	public void setStage(Stage stage) {
		...
		txtMAX.setNumber(new BigDecimal(RandomAlgorithm.MAX));
