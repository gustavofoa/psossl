...
public class ACOdHBAE extends HBAE {

	public static int	MAX	= 10000;

	public ACOdHBAE(Container container, List<Equipment> items, Type type) {
	...
	public void execute() {
		...
		try {
			...
			Logger.getLogger(ACOdHBAE.class.getName()).log(Level.SEVERE, null, ex);
		}
