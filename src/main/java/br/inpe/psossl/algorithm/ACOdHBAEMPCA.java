...
public class ACOdHBAEMPCA extends HBAE {

	public static int	MAX	= 10000;

	public ACOdHBAEMPCA(Container container, List<Equipment> items, Type type) {
	...
	public void execute() {
		...
		try {
			...
			Logger.getLogger(ACOdHBAEMPCA.class.getName()).log(Level.SEVERE, null, ex);
		}
