...
public class ACOd extends OptimizationAlgorithm {

	public static int	MAX	= 10000;

	public ACOd(Container container, List<Equipment> items) {
	...
	public void execute() {
		...
		try {
			...
			Logger.getLogger(ACOd.class.getName()).log(Level.SEVERE, null, ex);
		}
